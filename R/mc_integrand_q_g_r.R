#' Compute the Monte Carlo integrand for double integration in EffectXshift
#'
#' This function computes the Monte Carlo integrand for double integration in the EffectXshift package.
