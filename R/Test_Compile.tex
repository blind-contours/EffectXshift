...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{data\_info }\OtherTok{\textless{}{-}}\NormalTok{ EffectXshift}\SpecialCharTok{::}\FunctionTok{simulate\_data}\NormalTok{()}
...
Run the \texttt{EffectXshift} main function passing in the data, number of
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{sim\_results }\OtherTok{\textless{}{-}}\NormalTok{ EffectXshift}\SpecialCharTok{::}\FunctionTok{EffectXshift}\NormalTok{(}\AttributeTok{W =}\NormalTok{ W,}
