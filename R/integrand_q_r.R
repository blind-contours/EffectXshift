#' Integrand Function for Mediation Analysis in EffectXshift: Works for both Adaptive Quadrature and MC Methods for Integration
#'
#' Computes the integrand for mediation analysis in EffectXshift by combining the models for outcome given mediator and exposure (q_model), and the density of the mediator given exposure and covariates (r_model).
#'
